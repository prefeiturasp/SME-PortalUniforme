...
Se encontrou um bug no Portal do Uniforme você pode reportá-lo usando a ferramenta de [issues do GitHub](https://github.com/prefeiturasp/SME-PortalUniforme/issues). Porém antes de enviar seu bug é importante fazer as seguintes verificações:
...
Se o bug realmente não foi resolvido ou acolhido então está na hora de [criar uma nova issue](https://github.com/prefeiturasp/SME-PortalUniforme/issues/new).  Siga o template fornecido.
...
1. Certifique-se de que sua ideia já não esteja sendo abordada dentro do conjuntos de issues [issues do GitHub](https://github.com/prefeiturasp/SME-PortalUniforme/issues);
...
[criar uma nova issue](https://github.com/prefeiturasp/SME-PortalUniforme/issues/new) descrevendo as melhorias e usando o label **melhorias**./new) descrevendo as melhorias e usando o label **melhorias**.
...
Para criar seu pedido de recurso basta [criar uma nova issue](https://github.com/prefeiturasp/SME-PortalUniforme/issues/new) usando o label **recurso**. /new) usando o label **recurso**.
...
- Fale sobre o Portal do Uniforme nas suas redes sociais, blogs, etc. Espalhe a palavra;
